...
urlpatterns = [
    ...
    path('prelim_three_part_b_feedback', views.prelim_three_part_b_feedback, name="prelim_three_part_b_feedback"),
    ...
    path('prelim_three_part_b_feedback_second_go', views.prelim_three_part_b_feedback_second_go, name="prelim_three_part_b_feedback_second_go"),
    path('prelim_four', views.prelim_four, name="prelim_four"),
    path('prelim_five', views.prelim_five, name="prelim_five"),
